...
impl From<&u8> for SaturatingU16 {
    fn from(value: &u8) -> Self {
        SaturatingU16::new(value.to_owned().into())
    }
}

impl From<&u16> for SaturatingU16 {
    fn from(value: &u16) -> Self {
        SaturatingU16::new(value.to_owned())
    }
}
...
impl Add<&u16> for SaturatingU16 {
    ...
    fn add(self, rhs: &u16) -> Self::Output {
        SaturatingU16::new(self.value.saturating_add(rhs.to_owned()))
    }
}
...
impl std::cmp::PartialOrd for SaturatingU16 {
